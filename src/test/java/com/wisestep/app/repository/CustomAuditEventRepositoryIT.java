...
import com.wisestep.app.config.audit.AuditEventConverter;
import com.wisestep.app.domain.PersistentAuditEvent;
...
import static com.wisestep.app.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
